  ...
  function todoApp(){
    ...
    this.render = function () {
      ...
      for (var i = 0; i < this.todoCollection.length; i++) {
        ...
        $(addNew).html("<div id="+i+"><input type='checkbox' onclick='line(this)'><span>"+this.todoCollection[i].caption+"</span><button onclick='removeData("+i+",this)'> Remove </button></div>");
